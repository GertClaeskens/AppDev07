                ...
                Vragen = new List<Vraag>
                             {
                                 ...
                                 new Vraag
                                     {
                                         VraagStelling =
                                             "Denken (zoals fantaseren, een mening vormen, met idee�n spelen, of nadenken)"
                                 ...
                                 new Vraag
                                     {
                                         VraagStelling =
                                             "Financi�le mogelijkheden voor jezelf en je gezin"
                                 ...
                                 new Vraag { VraagStelling = "Sneller ge�rriteerd en prikkelbaar"
                                     ,Thema =  context.Themas.Find(10), Afbeelding=""},
                                 new Vraag { VraagStelling = "Onverschilligheid" ,Thema =  context.Themas.Find(10)},
                                 new Vraag
                                     {
                                         VraagStelling ="Ontremming en problemen met controle van gedag (zoals het maken van ongepaste opmerkingen, overmatig eten,�)"
                                         ,Thema =  context.Themas.Find(10)
                                     },
