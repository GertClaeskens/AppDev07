<?php
    ...
    require_once "../PHP/Models/Vraag.php";
?>
<!DOCTYPE html>
<html>
<head>
...
<div id="wrapper">
    ...
    <div id="inner-wrapper">
        ...
        <div id="body-container">
            <h3 id="Breadcrumb">Menu > Vragen > Bewerken</h3>

            <h2 id="Content-Title">Vraag bewerken</h2>
            <hr/>

            <form method="POST">
                <ul class="form-style"
                ">
                <!--TODO input velden voor geluid en afbeelding te veranderen -->
                ...
                <li><input class="form-control" value="Voorbeeld vraag" name="vraagstelling" type="text"/></li>
