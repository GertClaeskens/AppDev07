                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        ...
                        <form id="bevragingForm" class="form-horizontal" role="form" method="POST" name="myForm"
                            ...
                            <div class="form-group top-form">
                                <label class="control-label col-xs-4 col-sm-4 col-md-3 col-lg-3" for="Informatie">
                                    Informatie: </label>

                                <div class=" col-xs-8 col-sm-8 col-md-8 col-lg-4">
                                    <textarea rows="5" type="text" class="form-control" id="Informatie"
                                              name="informatie"><?php if (isset($_POST["bewerk"]) || isset($_POST["update"])) {
                                            echo $informatie;
                                        } ?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-xs-4 col-sm-4 col-md-3 col-lg-3" for="Aandoening"> Kies
                                    de aandoening: </label>

                                <div class="col-xs-8 col-sm-8 col-md-6 col-lg-4">
                                    <select class="form-control" id="Aandoening" name="aandoening"
                                            onchange="OnChange(event,'<?php echo $_SESSION['token']; ?>');OnChange2(event,'<?php echo $_SESSION['token']; ?>')">
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-4 col-sm-4 col-md-3 col-lg-3" for="Pathologie"> Kies
                                    de pathologie: </label>
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-4 col-sm-4 col-md-3 col-lg-3" for="Vragenlijst"> Kies
                                    de vragenlijst: </label>
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-4 col-sm-4 col-md-3 col-lg-3"
                                       for="LeeftijdcategoriePat"> Kies de leeftijdscategorie (patient): </label>
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-4 col-sm-4 col-md-3 col-lg-3"
                                       for="LeeftijdscategorieMan"> Kies de leeftijdscategorie (mantelzorger): </label>
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-4 col-sm-4 col-md-3 col-lg-3" for="Relatie"> Kies de
                                    relatie tussen patient en mantelzorger: </label>
