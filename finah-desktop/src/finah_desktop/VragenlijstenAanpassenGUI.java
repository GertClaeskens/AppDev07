...
public class VragenlijstenAanpassenGUI extends JFrame{
	
	private VragenlijstenAanpassenPanel panel;
	...
	private class VragenlijstenAanpassenPanel extends JPanel{
		public void paintComponent(Graphics g){
			...
			g2d.fillRect(100, 170, 800, 30*vragenlijsten.size());
			
			g2d.setPaint(Color.black);
			g2d.drawRect(100, 130, 800, 40);
			g2d.drawRect(100, 170, 800, 30*vragenlijsten.size());
			g2d.drawLine(870, 130, 870, 170+30*vragenlijsten.size());
			
			g2d.setFont(new Font("Arial", Font.BOLD, 17));
			g2d.drawString("Vragenlijsten", 435, 155);
			g2d.setFont(new Font("Arial", Font.PLAIN, 15));
			int hoogte = 200;
			for(int i=1; i<=vragenlijsten.size(); i++){
				g2d.drawLine(100, hoogte, 900, hoogte);
				JTextField vraagVeld = new JTextField("Vragenlijst "+i);
			...
			aanpassenLabel = new JLabel("Vragenlijsten aanpassen");
	...
	private class ButtonHandler implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			...
			case "FINAH":	newFrame = new AccountGUI();
							VragenlijstenAanpassenGUI.this.setVisible(false);
							break;
			...
			case "Accounts":	newFrame = new AccountsOverzichtGUI();
								VragenlijstenAanpassenGUI.this.setVisible(false);
								break;
			case "Wijzigingen opslaan":	newFrame = new VragenlijstenGUI();
										VragenlijstenAanpassenGUI.this.setVisible(false);
										break;
			}
		}		
	...
	public static void main(String[] args){
		VragenlijstenAanpassenGUI test = new VragenlijstenAanpassenGUI();
	}
