...
public class SharedDAO {
	...
	//Werkt niet normaal
	public static BufferedReader StuurGegevens(String url) throws ClientProtocolException, IOException {
		HttpClient client = new DefaultHttpClient();
